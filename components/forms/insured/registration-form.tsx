...
import { bloodGroups, statusOptions } from "@/constants";
...
export const InsuredRegistrationForm: React.FC<Props> = ({
  ...
  const [subscriberSelected, setSubscriberSelected] =
      ...
      >
        ...
        <div className="flex items-center flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            placeholder="Choisir un souscripteur"
            onChange={(value) => {
              const souscripteurItem = subscribers.find(
          ...
          <CustomFormField
            ...
            control={form.control}
            name="identifier"
            label="Identifiant de l'assuré"
            placeholder="Ex: DE345DDS"
          />
        </div>
